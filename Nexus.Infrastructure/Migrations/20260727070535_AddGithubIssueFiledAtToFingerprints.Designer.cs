...
namespace Nexus.Infrastructure.Migrations
{
    ...
    [Migration("20260727070535_AddGithubIssueFiledAtToFingerprints")]
    partial class AddGithubIssueFiledAtToFingerprints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.DocumentSuggestion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_document_suggestions");

                    b.HasIndex("CreatedAtUtc")
                        .HasDatabaseName("ix_document_suggestions_created_at_utc");

                    b.HasIndex("DocId")
                        .HasDatabaseName("ix_document_suggestions_doc_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_document_suggestions_user_id");

                    b.ToTable("document_suggestions", (string)null);
                });
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.Enquiry", b =>
                {
                    ...
                    b.Property<string>("DraftSources")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("draft_sources");
                    ...
                    b.HasIndex("LeaseId")
                        .HasDatabaseName("ix_enquiries_lease_id");
                    ...
                    b.HasIndex("TenantId")
                        .HasDatabaseName("ix_enquiries_tenant_id");
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.FileUpload", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<DateTimeOffset>("SasExpiresAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("sas_expires_at_utc");
                    ...
                    b.HasIndex("IngestionStatus")
                        .HasDatabaseName("ix_file_uploads_ingestion_status");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_file_uploads_user_id");

                    b.HasIndex("Status", "SasExpiresAtUtc")
                        .HasDatabaseName("ix_file_uploads_status_sas_expires_at_utc");

                    b.ToTable("file_uploads", (string)null);
                });

            modelBuilder.Entity("Nexus.Domain.Entities.Fingerprint", b =>
                {
                    ...
                    b.Property<bool>("AutoFixEligible")
                        .HasColumnType("boolean")
                        .HasColumnName("auto_fix_eligible");
                    ...
                    b.Property<DateTimeOffset?>("GithubIssueFiledAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("github_issue_filed_at_utc");

                    b.Property<int?>("GithubIssueNumber")
                        .HasColumnType("integer")
                        .HasColumnName("github_issue_number");

                    b.Property<DateTimeOffset?>("GithubLastCommentedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("github_last_commented_at_utc");
                    ...
                    b.HasIndex("Hash")
                        .IsUnique()
                        .HasDatabaseName("ix_fingerprints_hash");

                    b.HasIndex("GithubStatus", "Level")
                        .HasDatabaseName("ix_fingerprints_github_status_level");

                    b.ToTable("fingerprints", (string)null);
                });

            modelBuilder.Entity("Nexus.Domain.Entities.FingerprintOccurrence", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_fingerprint_occurrences");

                    b.HasIndex("FingerprintId", "OccurredAt")
                        .HasDatabaseName("ix_fingerprint_occurrences_fingerprint_id_occurred_at");

                    b.ToTable("fingerprint_occurrences", (string)null);
                });

            modelBuilder.Entity("Nexus.Domain.Entities.IngestCursor", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("LastPolledTo")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_polled_to");
                    ...
                    b.HasKey("Source")
                        .HasName("pk_ingest_cursor");

                    b.ToTable("ingest_cursor", (string)null);
                });
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.InspectionBooking", b =>
                {
                    ...
                    b.HasIndex("InspectionSlotId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_inspection_bookings_inspection_slot_id_user_id")
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("CreatedAtUtc")
                        .HasDatabaseName("ix_invoices_created_at_utc");
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.Lease", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<DateOnly?>("VacatingDate")
                        .HasColumnType("date")
                        .HasColumnName("vacating_date");

                    b.Property<string>("VacatingReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("vacating_reason");

                    b.Property<decimal?>("WaterAllowanceLitresPerDay")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                        .HasColumnName("water_allowance_litres_per_day");

                    b.Property<bool>("WaterIncluded")
                        .HasColumnType("boolean")
                        .HasColumnName("water_included");

                    b.Property<decimal>("WeeklyRent")
                        .HasPrecision(18, 2)
                        .HasColumnType("numeric(18,2)")
                        .HasColumnName("weekly_rent");

                    b.HasKey("Id")
                        .HasName("pk_leases");

                    b.HasIndex("AgentId")
                        .HasDatabaseName("ix_leases_agent_id");

                    b.HasIndex("PropertyId")
                        .HasDatabaseName("ix_leases_property_id");
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.Tenant", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("LeaseId")
                        .HasDatabaseName("ix_tenants_lease_id");

                    b.HasIndex("PropertyId")
                        .HasDatabaseName("ix_tenants_property_id");
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.TenantPreferences", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uuid")
                        .HasColumnName("user_id");

                    b.Property<int>("AvailableWithinDays")
                        .HasColumnType("integer")
                        .HasColumnName("available_within_days");
                    ...
                    b.Property<int>("MaxRent")
                        .HasColumnType("integer")
                        .HasColumnName("max_rent");

                    b.Property<int>("MinBeds")
                        .HasColumnType("integer")
                        .HasColumnName("min_beds");
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.DocumentSuggestion", b =>
                {
                    b.HasOne("Nexus.Domain.Entities.User", "User")
                        .WithMany("DocumentSuggestions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_document_suggestions_users_user_id");
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.Enquiry", b =>
                {
                    ...
                    b.HasOne("Nexus.Domain.Entities.Lease", null)
                        .WithMany("Enquiries")
                        .HasForeignKey("LeaseId")
                        .HasConstraintName("fk_enquiries_leases_lease_id");
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.FileUpload", b =>
                {
                    b.HasOne("Nexus.Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_file_uploads_users_user_id");
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.FingerprintOccurrence", b =>
                {
                    b.HasOne("Nexus.Domain.Entities.Fingerprint", "Fingerprint")
                        .WithMany("Occurrences")
                        .HasForeignKey("FingerprintId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_fingerprint_occurrences_fingerprints_fingerprint_id");
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.Invoice", b =>
                {
                    ...
                    b.OwnsMany("Nexus.Domain.Entities.InvoiceLineItem", "LineItems", b1 =>
                        {
                            ...
                            b1.ToJson("line_items");

                            b1.WithOwner()
                                .HasForeignKey("InvoiceId")
                                .HasConstraintName("fk_invoices_invoices_invoice_id");
                        });
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.Lease", b =>
                {
                    b.HasOne("Nexus.Domain.Entities.Agent", "Agent")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_leases_agents_agent_id");
                    ...
                    b.HasOne("Nexus.Domain.Entities.Property", "Property")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_leases_properties_property_id");
                    ...
                    b.HasOne("Nexus.Domain.Entities.Tenant", "Tenant")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_leases_tenants_tenant_id");
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.Tenant", b =>
                {
                    b.HasOne("Nexus.Domain.Entities.Lease", "Lease")
                        .WithMany()
                        .HasForeignKey("LeaseId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_tenants_leases_lease_id");
                    ...
                    b.HasOne("Nexus.Domain.Entities.Property", "Property")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_tenants_properties_property_id");
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.TenantPreferences", b =>
                {
                    b.HasOne("Nexus.Domain.Entities.User", "User")
                        ...
                        .HasForeignKey("Nexus.Domain.Entities.TenantPreferences", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tenant_preferences_users_user_id");
            ...
            modelBuilder.Entity("Nexus.Domain.Entities.User", b =>
                {
                    ...
                    b.Navigation("DocumentSuggestions");
