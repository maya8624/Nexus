...
namespace Nexus.Application.Interfaces.Business
{
    ...
    {
        Task<Result<InspectionSlotDto>> CreateAsync(CreateInspectionSlotRequest request, CancellationToken ct);
        Task<Result<IReadOnlyList<InspectionSlotDto>>> GetAvailableSlotsAsync(Guid listingId, CancellationToken ct);
